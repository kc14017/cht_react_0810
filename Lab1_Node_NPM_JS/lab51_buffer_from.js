...
const string2 = "中文"
var buffer0 = new Buffer.from(string2)
var buffer1 = new Buffer.from(string2, "ascii")
var buffer2 = new Buffer.from(string2, "utf8")
var buffer3 = new Buffer.from(string2, "utf16le")
var buffer4 = new Buffer.from(string2, "ucs2")
//var buffer5 = new Buffer.from(string2, "big5")
